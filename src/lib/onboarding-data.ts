...
export type TourStep = {
  ...
  title: string;
  text: string;
  navigateTo?: string; // relative path segment like "transcripts", "codebook", etc.
};
...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: "Dashboard",
    text: "This is your dashboard. Your projects live here. Each project is one research study. For your thesis, you will have one project shared with your partner.",
  },
  {
    id: "transcripts",
    ...
    title: "Transcripts",
    text: "This is the Transcript Manager. Upload your interview recordings here after transcribing them. Assign each transcript to either you or your partner. Each of you will code the transcripts assigned to you.",
  },
  {
    id: "codebook",
    ...
    navigateTo: "codebook",
    title: "Codebook",
    text: "This is the Codebook. As you code, your codes appear here. For each code, write a definition and an example quote. This is how you and your partner stay consistent — you are both working from the same definitions. The AI will flag it if your codes start to drift apart.",
  },
  {
    id: "memos",
    ...
    navigateTo: "memos",
    title: "Memo Pad",
    text: "This is the Memo Pad. Write one every time you notice something significant in the data. Not a summary — an observation, a question, a tentative argument. The AI scores each memo and challenges you to think deeper. Memos with a T score are the raw material of your theory.",
  },
  {
    id: "literature",
    attachTo: "[data-tour='literature-link']",
    navigateTo: "literature",
    title: "Literature",
